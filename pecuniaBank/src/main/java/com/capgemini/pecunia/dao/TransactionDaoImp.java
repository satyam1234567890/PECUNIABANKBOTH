...
public class TransactionDaoImp implements TransactionDao {
	...
	@Override
	public TransactionDetails setTransactionDeails(AccountDetails accountDetails, DepositSlip slip) {
		// TODO Auto-generated method stub
		TransactionDetails transaction=new TransactionDetails();
		transaction.setAccountNumber(accountDetails.getAccountNumber());
		transaction.setTransactionAmount(slip.getAmount());
	...
	@Override
	public TransactionDetails setTransactionDeails1(AccountDetails accountDetails, Cheque cheque, DepositSlip slip) {
		// TODO Auto-generated method stub
		TransactionDetails transaction=new TransactionDetails();
		transaction.setAccountNumber(cheque.getAccountNumber());
		transaction.setTransactionAmount(cheque.getAmount());
	...
	//set transaction statement by cheque deposit
	@Override
	public TransactionDetails setTransactionDeails2(AccountDetails accountDetails, Cheque cheque, DepositSlip slip) {
		// TODO Auto-generated method stub
		TransactionDetails transaction=new TransactionDetails();
		transaction.setAccountNumber(cheque.getAccountNumber());
		transaction.setTransactionAmount(cheque.getAmount());
