        ...
        if(cheque.getBankName().equals("PECUNIA"))
        {
        	...
        	if(transactionDao.checkAccountNumber(cheque.getAccountNumber()))
        	{
        		...
        		if(accountDetails1.getChequeNumber()==cheque.getChequeNumber()) {
        			...
        			{
            			transactionDao.updateBalance(accountDetails.getAccountNumber(),(accountDetails1.getAccountBalance()-cheque.getAmount()));
        				transactionDao.setTransactionDeails2(accountDetails1, cheque, slip);
        				return transactionDao.setTransactionDeails1(accountDetails, cheque, slip);
